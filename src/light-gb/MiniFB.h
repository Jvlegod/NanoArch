...
/**
 * Convert separate RGB values to 32-bit XRGB value.
 */
#define MFB_RGB(r, g, b) (((unsigned)r) << 16) | (((unsigned)g) << 8) | b
...
/**
 * Update the display. Input buffer is assumed to be a 32-bit buffer of the size
 * given in the open call.
 *
